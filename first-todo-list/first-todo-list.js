...
function completeItem() {
    ...
    // Check if the item should be added to completed or to re-added to todo list
    if (parentID === 'todo') {
        data.todo.splice(data.todo.indexOf(value), 1);
...
function addItemToDOM(text, isCompleted) {
